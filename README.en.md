...
|------|------|
| **[Dashboard demo](https://lowtidebuild.github.io/parlawatch/)** | Dashboard demo populated with sample data from the healthcare/pharma industry |
| **[System architecture](https://lowtidebuild.github.io/parlawatch/architecture.html)** | 10 sections — pipeline, transcript extraction, AI analysis, data model, configuration |
...
```bash
git clone https://github.com/lowtidebuild/parlawatch.git
cd parlawatch
```
...
const CONFIG = {
  ...
  SHEETS_API_KEY: '',        // the API key from Prerequisite #2

  GH_OWNER: 'your_github_id',                   // e.g., 'lowtidebuild'
